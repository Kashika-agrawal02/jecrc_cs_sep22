...
values={'Pair Plot':'sns.pairplot(data=data)',
        'Jointplot':"sns.jointplto(data=data,x='{col1}',y'{col2}')",
...
def show():
   ...
   # print(graphs.get())
    ...
    img=image=ImageTk.PhotoImage(Image.open('graph.png').resize((250,200)))
