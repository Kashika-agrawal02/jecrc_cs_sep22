...
app.title('House Price Predicter')
...
num_room = ttk.Variable(app)
ttk.Label(app,text='Number of rooms',padx=15,pady=15,background='white').grid(row=2,column=0)
ttk.Entry(app,textvariable=num_room ,width=10).grid(row=2,column=1)
...
def prediction():
    ...
    query_data={
        ...
        'Avg. Area Number of Rooms':[eval(num_room.get())],
