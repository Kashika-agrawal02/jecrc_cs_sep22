...
#ttk.Entry(app,textvariable=)

def abc():
    print('wow')
    msg.set('as ur wish')
ttk.Button(app,text='Isko click kro ',command=abc,font=('Arial',18)).place(x=100,y=100)
ttk.Button(app,text='ye wala bhi h ',font=('Arial',18),command=lambda:msg.set('dont know')).\
    place(x=100,y=160)             
f1=ttk.Variable(app)
f1.set('0')
f2=ttk.Variable(app)
f2.set('0') 
result=ttk.Variable(app) #.\for sencon line
